...
\end{abstract}
    ...
    \section{Introduction}
        ...
        Optics and lenses are fundamental to modern physics, with applications spanning from astronomical observations to cutting-edge technological advancements. Despite their significance, the foundational principles governing optical systems are often taken for granted. This experiment aims to rigorously test the thin lens equation through precise measurements using a variety of lenses.
